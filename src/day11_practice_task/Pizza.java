...
public class Pizza {
    ...
    public double calcCost() {
        ...
        if (size.equalsIgnoreCase("Small")) {
            int totalCost = 10 + 2 * (numberOfCheeseTopping + numberOfPepperoniTopping);
            return totalCost;
        }
        if (size.equalsIgnoreCase("Medium")) {
            int totalCost = 12 + 2 * (numberOfCheeseTopping + numberOfPepperoniTopping);
            return totalCost;
        }
        if (size.equalsIgnoreCase("Large")) {
            int totalCost = 14 + 2 * (numberOfCheeseTopping + numberOfPepperoniTopping);
            return totalCost;
        }
        return 0;
    }
