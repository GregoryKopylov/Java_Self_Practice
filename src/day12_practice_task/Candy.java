...
public class Candy {
    ...
    public void setQuantity(int quantity) {
        if(quantity <= 0){
            System.err.println("Quantity of candy can not be negative number or 0");
            System.exit(1);
        }
    ...
    public void setPrice(double price) {
        if(price < 0){
            System.err.println("Price can not be a negative number");
            System.exit(1);
        }
       /* if(price == 0){
            System.err.println("The candy is free");
        }*/
        this.price = price;
    }
